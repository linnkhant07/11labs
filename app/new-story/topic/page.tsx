...
function ChooseTopic() {
  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden bg-gradient-to-b from-[#fcebdc] to-white">
      {/* Back button */}
      <button
        onClick={() => router.push(`/new-story?narrator=${narrator}`)}
        aria-label="Go back"
      ...
      <DecorLeaf
        ...
        size={128}
        rotate={26.41}
        className="left-[15%] top-[42%] hidden md:block"
      />
      <DecorLeaf
        src="/figma/category/leaf-5.svg"
        size={89}
        rotate={-26.87}
        className="left-[7%] top-[60%] hidden md:block"
      />
      <DecorLeaf
        src="/figma/category/leaf-6.svg"
        size={128}
        rotate={-18.1}
        className="right-[5%] top-[55%] hidden md:block"
      />
      <DecorLeaf
        src="/figma/category/leaf-7.svg"
        size={64}
        rotate={-111.96}
        className="right-[18%] top-[50%] hidden md:block"
      />
      <DecorLeaf
        src="/figma/category/leaf-8.svg"
        size={44}
        rotate={-65.86}
        className="right-[12%] top-[38%] hidden md:block"
      />
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-[1280px] flex-col items-center justify-center gap-14 px-6 py-20 md:px-20">
        ...
        <section className="flex w-full max-w-[662px] flex-col items-center gap-8 rounded-[24px] border border-white bg-white p-6 shadow-[2px_2px_5px_rgba(0,0,0,0.1)] md:gap-10 md:p-12">
          <button
            type="button"
            className="flex items-center justify-center gap-4 transition-transform hover:scale-[1.03] focus:outline-none"
          >
            <span className="font-grandstander text-[22px] font-medium text-[#f29337] md:text-[28px]">
              Generate More
            </span>
            <RefreshIcon />
          </button>
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: isSelected
                      ? "2px 3px 0px 0px #f29337, 2px 2px 2px 0px rgba(0,0,0,0.25)"
                      : "2px 3px 0px 0px #cfcfcf, 2px 2px 2px 0px rgba(0,0,0,0.1)",
                  }}
                >
                  <span className="text-[20px] leading-none md:text-[24px]">
                    {t.emoji}
                  </span>
                  <span
                    className="whitespace-nowrap text-[16px] font-semibold text-black md:text-[20px]"
...
function RefreshIcon() {
  return (
    <div className="relative size-6 overflow-hidden md:size-7">
      <div className="absolute inset-[8.33%_8.33%_45.83%_8.33%]">
        <img src="/figma/topic/refresh-1.svg" alt="" className="size-full" />
      </div>
      <div className="absolute inset-[8.33%_8.33%_62.5%_62.5%]">
        <img src="/figma/topic/refresh-2.svg" alt="" className="size-full" />
      </div>
      <div className="absolute inset-[45.83%_8.33%_8.33%_8.33%]">
        <img src="/figma/topic/refresh-3.svg" alt="" className="size-full" />
      </div>
      <div className="absolute inset-[62.5%_62.5%_8.33%_8.33%]">
        <img src="/figma/topic/refresh-4.svg" alt="" className="size-full" />
      </div>
    </div>
  );
}
...
function SparkleIcon() {
  return (
    <div className="relative size-6 overflow-hidden md:size-7">
      <div className="absolute inset-[4.17%_4.16%_4.17%_4.17%]">
        <img src="/figma/landing/sparkle-1.svg" alt="" className="size-full" />
      </div>
      <div className="absolute inset-[8.33%_12.5%_66.67%_79.17%]">
        <img src="/figma/landing/sparkle-2.svg" alt="" className="size-full" />
      </div>
      <div className="absolute bottom-3/4 left-[70.83%] right-[4.17%] top-[16.67%]">
        <img src="/figma/landing/sparkle-3.svg" alt="" className="size-full" />
      </div>
      <div className="absolute inset-[66.67%_79.17%_16.67%_12.5%]">
        <img src="/figma/landing/sparkle-4.svg" alt="" className="size-full" />
      </div>
      <div className="absolute bottom-[20.83%] left-[8.33%] right-3/4 top-[70.83%]">
        <img src="/figma/landing/sparkle-5.svg" alt="" className="size-full" />
      </div>
    </div>
  );
}
